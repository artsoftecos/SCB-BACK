...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/","/login","/applicant", "/offerer", "/documentType/", "/applicant/welcome/*", "/offerer/approve/*", "/offerer/reject/*", "/applicantDocument", "/offerer/approved", "/offerer/pending", 
				...
				"/phase/getCurrentPhase/**", "/applicant/acceptConvocatory/**","/applicant/rejectPlace", "/AppPerPhase/applicantsPerPhase/**",
				"/convocatory/upload", "/convocatory/downloadDocument").permitAll()
		.anyRequest()
			.fullyAuthenticated()
		.and()
			.httpBasic()
